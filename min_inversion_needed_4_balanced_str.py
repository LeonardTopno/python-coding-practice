def findMinInvFrBalParenthesis(exp):
    if len(exp)%2:
    ...
    return abs(unbalanced_count)//2    # Python in-built func abs(x); // - int part of division result; you may also use int(abs(count)/2) 
...
# exp = "{{}{{}{{"
#exp="}}}}"
print(findMinInvFrBalParenthesis(exp))
